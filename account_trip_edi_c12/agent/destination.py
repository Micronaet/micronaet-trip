...
#
###############################################################################
# Stampa di controllo per rappresentare le destinazioni attualmente presenti
# negli ordini (utilizzata dal personale per verificare i dati a gestionale)
###############################################################################
import pdb
import sys
import os
...
# Parameters:
extension = 'txt'
history_path = os.path.expanduser('~/etl/edi/sercar/order/history')
